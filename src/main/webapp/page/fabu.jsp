...
<DIV class=box>
<FORM id=add_action method="post"  action="${rt}/house/add.html">
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
  ...
  <TR>
    ...
    <TD>
      ...
      <c:forEach items="${hts}" var="houseType">
        <OPTION value="${houseType.htypeId}">${houseType.htypeName}</OPTION>
      </c:forEach>
    </SELECT>
    </TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD><INPUT id="pubDate"  class=text type=text name="pubdate" ></TD></TR>
  <TR>
...
<script src="${rt}/js/pubish.js"></script>
